...
parser.add_argument("-N",        type=int,   help="Number of particles",      default=256*10)
parser.add_argument("-L",        type=float, help="Lateral size of the box",  default=600.) 
...
parser.add_argument("-EpsNP1", type=float, help="Int. energy NP-prot 1", default=8.0) 
...
parser.add_argument("-EpsProt1", type=float, help="Attr. energy prot-prot 1", default=0.00) 
parser.add_argument("-EpsProt2", type=float, help="Attr. energy prot-prot 2", default=0.00)
parser.add_argument("-EpsProt3", type=float, help="Attr. energy prot-prot 3", default=0.00)
...
parser.add_argument("-C_NP",    type=float, help="Conc. of NPs",              default=0.100)
parser.add_argument("-C_Prot1", type=float, help="Conc. of Protein 1",        default=0.005)
parser.add_argument("-C_Prot2", type=float, help="Conc. of Protein 2",        default=0.350)
parser.add_argument("-C_Prot3", type=float, help="Conc. of Protein 3",        default=0.350)

# density of the NP in g/cm3 (COULD BE SET AS AN ARGUMENT)
rho_SiO2 = 2.65  
...
M_NP = rho_SiO2 * V_NP                  # g/cm3 * cm3 = grams

print "Mass of the NP: ", M_NP
...
print "Lenght of the box: ", L_box_1NP
...
print "Number of proteins per NP: "
print N_Ref
...
print "Minimum number of proteins in simulation box: "
print N_min
...
print "Simulation box geometry"
print "Lbox ", L, " Lreaction ", Lreaction, " boundaries ", Lmin, Lmax
...
f1.write('%d\t%f\t%f\t%f\t%f\t%d\t%d\t%d\n' % (N+1,args.C_PBS,L,V, L_box_1NP, N_Ref[0], N_Ref[1], N_Ref[2])) # capc,alera de l'arxiu
...
#	conc /= 10            # g/dL
	...
	print("%d\tmolecules of type %d with concentration %1.5e M=1mol/L" % (N,i,conc/0.6))
