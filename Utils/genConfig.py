...
parser.add_argument("-C_Prot1", type=float, help="Conc. of Protein 1",        default=0.10)
parser.add_argument("-C_Prot2", type=float, help="Conc. of Protein 2",        default=0.10)
parser.add_argument("-C_Prot3", type=float, help="Conc. of Protein 3",        default=0.10)
...
parser.add_argument("-Nmin_Prot2", type=float, help="Min Num. Protein 2",     default=300)
parser.add_argument("-Nmin_Prot3", type=float, help="Min Num. Protein 3",     default=500)
